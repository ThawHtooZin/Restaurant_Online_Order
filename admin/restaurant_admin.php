    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col">
            <h3 class="card-title" style="float:right;"><a href="restaurant_add.php" class="btn btn-success"> + ADD</a></h3>
          </div>
        </div>
      </div>
      <!-- /.card-header -->
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><img src="../images/product_image/<?php echo $data['image']; ?>" alt="" style="width:300px;"></td>
